...
export function AmbientBackdrop() {
  return (
    <div aria-hidden className="pointer-events-none fixed inset-0 z-0 overflow-hidden">
      <div
        className="absolute inset-0 bg-cover bg-center opacity-[0.18] saturate-[0.82]"
        style={{
      ...
      <div className="absolute inset-0 bg-[radial-gradient(70%_55%_at_76%_28%,hsl(var(--accent-cool)/0.1),transparent_62%),radial-gradient(58%_42%_at_17%_72%,hsl(var(--accent-warm)/0.06),transparent_58%)]" />
