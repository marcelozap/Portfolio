...
previously reserved for them. Avoid unrelated movement and career promotion.

## Visual Direction

Preserve the approved dragon design. The supplied artwork shows a serpentine
Eastern dragon in violet, magenta, and cyan against black. Use the 400 × 400
dragon emblem for compact surfaces and the 1200 × 600 dragon world artwork for
wider surfaces. Keep XIV lettering in the site's typography where needed.

Use strong typography, generous space, and clear reading order. Keep artwork
clear of navigation and copy, preserve responsive layouts and accessible
contrast, and respect reduced-motion preferences. The bull artwork is no longer
XIV's primary identity.
...
`gatekpt.ai` remains under construction at Marcelo's request. Do not restore it
as XIV's public home or promote it as an active destination.

Website edits do not imply that connected profiles or accounts have changed.
