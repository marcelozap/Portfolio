# Remote / Hybrid Role Targets

Primary target: remote or hybrid roles in software engineering or QA automation.
...
- jobs that want senior-level ownership without matching pay or scope
- AI roles that are actually ML research, model training, or deep data science jobs
