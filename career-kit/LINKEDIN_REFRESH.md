...
## Short headline option

Software Engineer building reliable systems, automation, and product software
...
C#, TypeScript, React, Next.js, Python, Swift, Playwright, Azure, Snowflake, Databricks, Power BI, CI/CD, API integrations, QA automation, workflow tooling
